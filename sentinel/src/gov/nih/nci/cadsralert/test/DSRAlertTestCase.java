...
// $Header: /share/content/gforge/sentinel/sentinel/src/gov/nih/nci/cadsralert/test/DSRAlertTestCase.java,v 1.3 2006-05-17 20:17:02 hardingr Exp $
...
public class DSRAlertTestCase extends MockStrutsTestCase
{
  ...
  public void setUp() throws Exception
  {
    ...
    ResourceBundle testProperties = PropertyResourceBundle.getBundle("gov.nih.nci.cadsralert.test.DSRAlertTest");
    ...
    getSession().getServletContext().setAttribute(
        ...
        new PropertyMessageResources(MessageResourcesFactory.createFactory(),
            "gov.nih.nci.cadsralert.DSRAlert"));
  }

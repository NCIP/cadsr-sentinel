...
// $Header: /share/content/gforge/sentinel/sentinel/src/gov/nih/nci/dsralert/test/DSRAlertTestCase.java,v 1.1 2006-05-17 20:17:03 hardingr Exp $
// $Name: not supported by cvs2svn $

package gov.nih.nci.dsralert.test;

import gov.nih.nci.dsralert.AlertBean;
import gov.nih.nci.dsralert.Constants;
import gov.nih.nci.dsralert.DBAlert;
...
public class DSRAlertTestCase extends MockStrutsTestCase
{
  ...
  public void setUp() throws Exception
  {
    ...
    ResourceBundle testProperties = PropertyResourceBundle.getBundle("gov.nih.nci.dsralert.test.DSRAlertTest");

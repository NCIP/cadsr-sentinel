...
echo "\$Header: /share/content/gforge/sentinel/sentinel/scripts/autorun.sh,v 1.5 2007-12-17 18:28:24 hebell Exp $"
...
$JAVA_HOME/bin/java -client $JAVA_PARMS -classpath $BASE_DIR/commons-logging-1.1.jar:$BASE_DIR/log4j-1.2.13.jar:$BASE_DIR/jdom-1.0.jar:$BASE_DIR/stax-api-1.0.1.jar:$BASE_DIR/mail.jar:$BASE_DIR/activation.jar:$BASE_DIR/ojdbc14.jar:$BASE_DIR/cacore32-client.jar:$BASE_DIR/hibernate3.jar:$BASE_DIR/spring.jar:$BASE_DIR/cglib-2.1.3.jar:$BASE_DIR/asm.jar:$BASE_DIR/cadsrsentinel.jar gov.nih.nci.cadsr.sentinel.tool.AutoProcessAlerts $BASE_DIR/log4j.xml true $BASE_DIR/cadsrsentinel.xml

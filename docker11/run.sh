...
echo ant -file build.xml -Ddebug=false -DBRANCH_OR_TAG=${BRANCH_OR_TAG} -Dtiername=${tiername} -DCADSR.DS.USER=${CADSR_DS_USER} -DCADSR.DS.PSWD=******** -DCADSR.DS.TNS.HOST=${CADSR_DS_HOST} -DTOOL.BASE.DIR=${TOOL_BASE_DIR} -DTEST=false -DCADSR.DS.TNS.SID=${CADSR_DS_TNS_SID} -DJDEBUG=off -DCADSR.DS.TNS.PORT=${CADSR_DS_TNS_PORT} build-product
ant -file build.xml -Ddebug=false -DBRANCH_OR_TAG=${BRANCH_OR_TAG} -Dtiername=${tiername} -DCADSR.DS.USER=${CADSR_DS_USER} -DCADSR.DS.PSWD=${CADSR_DS_PSWD} -DCADSR.DS.TNS.HOST=${CADSR_DS_HOST} -DTOOL.BASE.DIR=${TOOL_BASE_DIR} -DTEST=false -DCADSR.DS.TNS.SID=${CADSR_DS_TNS_SID} -DJDEBUG=off -DCADSR.DS.TNS.PORT=${CADSR_DS_TNS_PORT} build-product

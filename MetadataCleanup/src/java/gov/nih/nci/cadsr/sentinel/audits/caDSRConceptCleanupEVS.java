...
//            if (text != null && text.length == 2 && text[2].equals("ALL"))            
        ...
        for (ConceptItem rec : concepts)
        {
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    System.out.println(" ed._cons" + ed._cons);
    ...
    public List<EVSConcept> resolveNodeSet(CodedNodeSet cns, boolean includeRetiredConcepts) throws Exception {
    	System.out.println("Testing CodeNodeSet ="+cns +"and include Retired Concepts ="+ includeRetiredConcepts);
		...
		System.out.println("testing the results =" +results);
	...
	//    	System.out.println("=======" + cleanup_msg + "=======");
	        ...
	        try
	        {
	    //    	System.out.println("Printing the rec " +rec._longName+" : "+rec._definitionSource+" : "+rec._workflow_status+" : "+rec._preferredDefinition);
	    //    	System.out.println("Printing the evsrec " +evsrec._longName+" : "+evsrec._definitionSource+" : "+evsrec._workflow_status+" : "+evsrec._preferredDefinition);
	        	if ((rec._evsSource.equals("NCI_CONCEPT_CODE"))
	    				&& (rec._origin.equals("NCI Thesaurus"))) {
	        	updated = meta.updateCADSRConcept(rec, evsrec, updateLongName, updateDefn, updateStatus, updateDefnSrc, ret_info, _db.getConnection());
	        		...
	        		cleanup_msg+= " - EVS Source or origin doesn't match";
	        	}	        	
	        	if (updated) {

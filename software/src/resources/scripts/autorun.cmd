...
%JAVA_HOME%/bin/java -client %JAVA_PARMS% %BASE_DIR%;%BASE_DIR%/commons-lang-2.4.jar;%BASE_DIR%/commons-logging-1.1.jar;%BASE_DIR%/log4j-1.2.14.jar;%BASE_DIR%/jdom-1.0.jar;%BASE_DIR%/stax-api-1.0.1.jar;%BASE_DIR%/mail.jar;%BASE_DIR%/activation.jar;%BASE_DIR%/ojdbc14.jar;%BASE_DIR%/axis.jar;%BASE_DIR%/j2ee.jar;%BASE_DIR%/commons-discovery-0.2.jar;%BASE_DIR%/lucene-core-2.4.0.jar;%BASE_DIR%/lucene-regex-2.4.0.jar;%BASE_DIR%/acegi-security-1.0.4.jar;%BASE_DIR%/sdk-client-framework.jar;%BASE_DIR%/hibernate3.jar;%BASE_DIR%/spring.jar;%BASE_DIR%/cglib-2.1.3.jar;%BASE_DIR%/asm.jar;%BASE_DIR%/cadsrsentinel.jar;%BASE_DIR%/lexbig.jar;%BASE_DIR%/lexevsapi60-beans.jar;%BASE_DIR%/lexevs-client-framework.jar;%BASE_DIR%/lexevs-core.jar;%BASE_DIR%/LexEVSSecurity.jar;%BASE_DIR%/caGrid-CQL-cql.1.0-1.2.jar;%BASE_DIR%/LexEVS_localRuntime_dependencies.jar gov.nih.nci.cadsr.sentinel.tool.AutoProcessAlerts %BASE_DIR%/log4j.xml true %BASE_DIR%/cadsrsentinel.xml

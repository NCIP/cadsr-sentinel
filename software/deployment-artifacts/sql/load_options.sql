...
insert into sbrext.tool_options_view_ext (tool_name, property, value, description)
values ('SENTINEL', 'URL', 'https://cadsrsentinel-dev.nci.nih.gov',
'Deprecated, please use URN.');

insert into sbrext.tool_options_view_ext (tool_name, property, value, description)
values ('SENTINEL', 'URN', 'https://cadsrsentinel-dev.nci.nih.gov/cadsrsentinel/',
'The URN for the Sentinel Tool referencing this caDSR database.');

insert into sbrext.tool_options_view_ext (tool_name, property, value, description)
values ('SENTINEL', 'VERSION', '4.0.4-it-11.201602151459',
...
insert into sbrext.tool_options_view_ext (tool_name, property, value, description)
values ('SENTINEL', 'EMAIL.ADMIN.NAME', 'caDSR Alert DEV Administrator',
...
insert into sbrext.tool_options_view_ext (tool_name, property, value, description)
values ('SENTINEL', 'DB.NAME', 'NCICB DEVELOPMENT caDSR',
'The name to identify this database on report output.');
...
insert into sbrext.tool_options_view_ext (tool_name, property, value, description)
values ('SENTINEL', 'HELP.ROOT', 'https://cadsrsentinel-dev.nci.nih.gov/help/', 'The Sentinel Tool online help URL root');
insert into sbrext.tool_options_view_ext (tool_name, property, value, description)
